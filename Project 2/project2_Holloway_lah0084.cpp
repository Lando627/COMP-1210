...
int main() { 
 ...
 cout << "*** Welcome to Landon's Duel Simulator ***\n"; 
 srand(time(0)); 
...
TOTAL_RUNS * 100 << "%\n" 
 ...
 if (static_cast<double>(aaronWins1) / TOTAL_RUNS > static_cast<double>(aaronWins2) / TOTAL_RUNS) { 
